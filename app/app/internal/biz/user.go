...
type UserBalanceRepo interface {
	...
	NormalRecommendReward(ctx context.Context, userId int64, rewardAmount int64, rewardAmount2 int64, locationId int64, status string, status2 string, type1 string) (int64, error)
